# Semicircle v1: same geometry as v0, only lane widening (LANE_HALF_WIDTH is larger)
...
LANE_HALF_WIDTH = 0.55   # Lane half width (v1 widened: v0=0.35)
...
def start_rot():
    """The starting point is on the arc, tangential to the arc (direction of travel from left to right)."""
