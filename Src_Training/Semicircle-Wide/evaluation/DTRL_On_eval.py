"""Semicircle v6 On-policy DTRL dynamic port selection evaluation (same rules as dtrl_off_policy_eval / mms_eval).

e1: PPO obs→256 | e2: PPO obs→256→128→128 | ef: PPO obs→256→128→128→64→64
Forward: Gaussian mean + clip (not predict). Preheat 1000 steps + fill buffer 1000 steps + 100 seeds.

Run: python dtrl_onpolicy_eval.py"""
